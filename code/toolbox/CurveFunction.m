...
Rbak = x(1)*x(2)^2./( x(2)^2 + 4*(xdata ).^2 ) + x(3) + x(4)*0.001*(xdata - peakoffset) + x(5)*0.001*(xdata - peakoffset).^2; %%%%%%%quadratic term added%%%%%%%%
...
Ramide = x(6)*x(7)^2./( x(7)^2 + 4*(xdata - x(8)).^2 );
Rguan = x(9)*x(10)^2./( x(10)^2 + 4*(xdata - x(11)).^2 );
Ramine = x(12)*x(13)^2./( x(13)^2 + 4*(xdata - x(14)).^2 );
